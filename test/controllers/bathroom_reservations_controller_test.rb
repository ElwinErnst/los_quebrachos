...
class BathroomReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bathroom_reservation" do
    assert_difference('BathroomReservation.count') do
      post bathroom_reservations_url, params: { bathroom_reservation: { bathroom_id: @bathroom_reservation.bathroom_id, reservation_id: @bathroom_reservation.reservation_id } }
    end
  ...
  test "should update bathroom_reservation" do
    patch bathroom_reservation_url(@bathroom_reservation), params: { bathroom_reservation: { bathroom_id: @bathroom_reservation.bathroom_id, reservation_id: @bathroom_reservation.reservation_id } }
