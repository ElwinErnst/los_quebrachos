...
class BathroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bathroom" do
    assert_difference('Bathroom.count') do
      post bathrooms_url, params: { bathroom: { gender: @bathroom.gender, shower: @bathroom.shower, ubication: @bathroom.ubication } }
    end
  ...
  test "should update bathroom" do
    patch bathroom_url(@bathroom), params: { bathroom: { gender: @bathroom.gender, shower: @bathroom.shower, ubication: @bathroom.ubication } }
