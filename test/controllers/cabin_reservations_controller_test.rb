...
class CabinReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create cabin_reservation' do
    assert_difference('CabinReservation.count') do
      post cabin_reservations_url,
           params: { cabin_reservation: { cabin_id: @cabin_reservation.cabin_id, date: @cabin_reservation.date,
                                          reservation_id: @cabin_reservation.reservation_id } }
    end
  ...
  test 'should update cabin_reservation' do
    patch cabin_reservation_url(@cabin_reservation),
          params: { cabin_reservation: { cabin_id: @cabin_reservation.cabin_id, date: @cabin_reservation.date,
                                         reservation_id: @cabin_reservation.reservation_id } }
