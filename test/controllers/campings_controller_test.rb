...
class CampingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camping" do
    assert_difference('Camping.count') do
      post campings_url, params: { camping: { area: @camping.area, tents: @camping.tents, ubication: @camping.ubication } }
    end
  ...
  test "should update camping" do
    patch camping_url(@camping), params: { camping: { area: @camping.area, tents: @camping.tents, ubication: @camping.ubication } }
