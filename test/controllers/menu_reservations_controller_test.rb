...
class MenuReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create menu_reservation' do
    assert_difference('MenuReservation.count') do
      post menu_reservations_url,
           params: { menu_reservation: { date: @menu_reservation.date, menu_id: @menu_reservation.menu_id,
                                         reservation_id: @menu_reservation.reservation_id } }
    end
  ...
  test 'should update menu_reservation' do
    patch menu_reservation_url(@menu_reservation),
          params: { menu_reservation: { date: @menu_reservation.date, menu_id: @menu_reservation.menu_id,
                                        reservation_id: @menu_reservation.reservation_id } }
