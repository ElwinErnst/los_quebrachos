...
class RoomReservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_reservation" do
    assert_difference('RoomReservation.count') do
      post room_reservations_url, params: { room_reservation: { date: @room_reservation.date, reservation_id: @room_reservation.reservation_id, room_id: @room_reservation.room_id } }
    end
  ...
  test "should update room_reservation" do
    patch room_reservation_url(@room_reservation), params: { room_reservation: { date: @room_reservation.date, reservation_id: @room_reservation.reservation_id, room_id: @room_reservation.room_id } }
